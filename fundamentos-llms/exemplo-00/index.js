import tf, { InputSpec } from '@tensorflow/tfjs-node';
...
async function trainModel(inputXs, outputYs) {
    ...
    // quanto mais neurônios mais complexidade a rede tem para aprender
    ...
    // se a informação que chegou nesse neurônio é positiva passa para frente!
    // se for erro ou negativa pode jogar fora, não vai servir para nada
...
// Exemplo: idade_min = 25, idade_max = 45, então (28 - 25) / (40-25) = 0.2
